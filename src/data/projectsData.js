...
export const projectsData = [
  {
    ...
    description: "Developed a full-stack e-commerce platform with secure authentication, shopping cart functionality, Stripe payments, product management, real-time order tracking, and an administrative dashboard.",
    image: kindledImg,
